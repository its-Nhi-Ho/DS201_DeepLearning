import torch
from phoner import collate_fn, Vocab, phoNERDataset
...
CHECKPOINT_DIR = "/content/drive/MyDrive/Kì_1_Năm_3/DS200/DL-LAB3/3_BiLSTM"
...
if __name__ == "__main__":
    ...
    try:
        ...
        vocab = Vocab(data_files=[
          "/content/drive/MyDrive/Kì_1_Năm_3/DS200/DL-LAB3/phoNER/train_syllable.json",
          "/content/drive/MyDrive/Kì_1_Năm_3/DS200/DL-LAB3/phoNER/dev_syllable.json",
          "/content/drive/MyDrive/Kì_1_Năm_3/DS200/DL-LAB3/phoNER/test_syllable.json",
      ])

        logging.info("Creating dataset...")
        train_dataset = phoNERDataset(
            json_path="/content/drive/MyDrive/Kì_1_Năm_3/DS200/DL-LAB3/phoNER/train_syllable.json",
            vocab=vocab
        )

        test_dataset = phoNERDataset(
            json_path="/content/drive/MyDrive/Kì_1_Năm_3/DS200/DL-LAB3/phoNER/test_syllable.json",
            vocab=vocab
        )

        dev_dataset = phoNERDataset(
            json_path="/content/drive/MyDrive/Kì_1_Năm_3/DS200/DL-LAB3/phoNER/dev_syllable.json",
            vocab=vocab
        )
